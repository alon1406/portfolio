const SKILL_ICONS = [
  ...
  { name: 'Supabase', src: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/supabase/supabase-original.svg' },
  ...
  return (
    <section className="panel" id="skills" data-reveal>
      ...
      <div className="card">
        ...
        <p className="card__body">Python · Java · C · C++ · PostgreSQL · MongoDB · Supabase · Ubuntu · Git · Data Structures · OOP · Algorithms · Operating Systems · Machine Learning · Parallel & Distributed Computing · MPI · CUDA · HTML · CSS · JavaScript · TypeScript · Node.js · React</p>
      </div>
